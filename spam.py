...
cookies = input("\033[1;97mIsi cookies Facebook Anda: ")


def banner():
    banner = f"""
\033[1;97m~ \033[1;92mTool : \033[1;97mSpam Komen
\033[1;97m~ \033[1;92mAuthor : \033[1;97miPilih Prabowo Jadi presiden
\033[1;97m~ \033[1;92mFacebook : \033[1;97mGatau woi
\033[1;97m~ \033[1;92mGithub : \033[1;97mhttps://github.com/
\033[1;97m- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n"""
    for X in banner:
        sys.stdout.write(X)
        sys.stdout.flush()
...
num_threads = int(input("\033[1;97mLimit Komen anda: "))
linkReply = input("\033[1;97mLink Komen Status spam : ")
...
comment_text = ["Apis Ganteng  | iG Apisuu", " Dukung saya jadi presiden"]
